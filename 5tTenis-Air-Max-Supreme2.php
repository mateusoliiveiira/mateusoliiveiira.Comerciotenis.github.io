...
@keyframes glowing {
    ...
    100% { background-position: 0 0; }
			...
			<button class="glow-on-hover"	li><a href="paginaprodutos.php">Produtos</a></li>
			<button class="glow-on-hover"	li><a href="contato.php">Contato</a></li>      
			</ul>
		</nav>
	</header>
...
<main>
        ...
        <div class="product-info">
            <img src="imagens/Tenis Nike Air Max Supreme2.jpg" alt="Produto X">
            <h2>Air Max Supreme2</h2>
            <p>R$ 770,00</p>
